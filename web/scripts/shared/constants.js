(() => {
  ...
  shared.constants = {
    DOMAIN_META: {
      ...
      llm: { label: "llm" },
      cv: { label: "cv" },
      "multicore-realtime-scheduling": { label: "multicore-realtime-scheduling" },
      "system-and-cyber-security": { label: "system-and-cyber-security" },
