(() => {
  ...
  const renderStatus = () => {
    ...
    const mobileSummaryText = currentDateLabel ? `${currentDateLabel} · ${currentPapers.length || 0} papers` : "Not loaded";
    ...
    document.getElementById("local-status").innerHTML = `
      ...
      <details class="local-status-mobile">
        <summary class="local-status-mobile-summary"><span class="local-status-mobile-title">${escapeHtml(mobileSummaryText)}</span><span class="local-status-mobile-hint">Local</span></summary>
